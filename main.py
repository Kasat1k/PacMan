...
class Pacman:
    ...
    def move(self, maze, ghosts):
        self.counter += 1
        if self.counter % 30 == 0:  # Рух тільки на кожному 20-му кроці
    ...
    # Перевірка, чи є привид поруч з Пакманом
    ...
    # Пошук безпечної їжі або уникнення привидів
    ...
    # Пошук найкращого шляху для втечі від привидів
    ...
    def reconstruct_path(self, came_from, start, goal):
        ...
        path.reverse()
        return path
# Клас для привидів з різними поведінками
class Ghost:
    ...
    def move(self, maze, pacman):
        ...
        if self.counter % 30 == 0:  # Рух тільки на кожному 30-му кроці
    ...
    # Патрулювання точки з використанням DFS
    ...
    # Переслідування Пакмана з використанням A*
    ...
    # Перехоплення Пакмана з використанням BFS
    ...
    # Прогнозування позиції Пакмана для перехоплення
    ...
    # Зміна цілі патрулювання на випадкову точку біля їжі або поведінки
    ...
    # Випадковий вибір поведінки (рух на одну клітинку)
...
def main():
    ...
    while running:
        ...
        # Перевірка на перемогу Пакмана
        if not any('o' in row for row in maze):
            game_won = True
            game_over = True
        ...
        text = font.render(f"Score: {pacman.score}  Level: {level}  Press +/- to change lvl", True, WHITE)
